    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <div class="breadcrumb-wrapper col-12">
                <h3 class="content-header-title float-left mb-0">Edit Branch</h3>
                <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        <form action="{{ route('branches.update', $branch->branch_id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_number" class="form-control" value="{{ old('contact_number', $branch->contact_number) }}" required>
